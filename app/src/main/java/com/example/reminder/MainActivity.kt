...
class MainActivity : AppCompatActivity() {
    ...
    private fun createItemTouchHelper(): ItemTouchHelper {
        ...
        val callback = object : ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {
            ...
            // Callback triggered when a user swiped an item. Display a toast telling the user that
            // a remainder was deleted.
    ...
    // Display a message telling the user that a remainder was deleted
    // (called when user deletes a remainder)
    private fun remDeleted(){
